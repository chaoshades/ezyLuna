define(function (require) {
    ...
    return function (armors, current) {
        ...
        this.render = function () {
            ...
            var paged_armors = [];
            var temp = armors.slice(0);
            while (temp.length > 0) {
                paged_armors.push(temp.splice(0, 15));
            }

            var data = {
                'paged_armors': paged_armors,
                'current': current
            };
            this.$el.html(armorsTpl(data));
        ...
        this.setActiveMenuItem = function (id) {
            ...
            this.$el.find('.list-group a[href="#armors/' + id + '"]').addClass('active');
        };
