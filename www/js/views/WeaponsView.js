define(function (require) {
    ...
    return function (weapons, current) {
        ...
        this.render = function () {
            ...
            var paged_weapons = [];
            var temp = weapons.slice(0);
            while (temp.length > 0) {
                paged_weapons.push(temp.splice(0, 15));
            }

            var data = {
                'paged_weapons': paged_weapons,
                'current': current
            };
            this.$el.html(weaponsTpl(data));
        ...
        this.setActiveMenuItem = function (id) {
            ...
            this.$el.find('.list-group a[href="#weapons/' + id + '"]').addClass('active');
        };
